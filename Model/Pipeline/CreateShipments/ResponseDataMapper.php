...
class ResponseDataMapper
{
     ...
     * carrier and will be available later in the process. We set the DHL
     * Package ID as it can be used at the Tracking API in both cases.
     *
    ...
    public function createShipmentResponse(
        ...
        $responseData = [
            ...
            LabelResponseInterface::TRACKING_NUMBER => $label->getDhlPackageId(),
